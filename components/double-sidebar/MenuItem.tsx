...
export function MenuItem({
  ...
  return (
    ...
    >
      {/* Fixed height container for consistent icon positioning */}
      <button 
        className={`w-full h-10 transition-colors duration-200 rounded-md focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 hover:bg-accent hover:text-accent-foreground overflow-hidden ${
